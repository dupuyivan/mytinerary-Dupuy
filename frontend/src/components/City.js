...
const City = (props) =>{
  ...
  return<>
          <div className="fondo-city" style={{ backgroundImage:`url('${ data.img }')` }} >
              <div>
                  <NavLink to="/cities">
                    <button type="button" className="btn btn-outline-danger m-2"> <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" className="bi bi-arrow-left" viewBox="0 0 16 16">
